...
_G.jummpPower = true
_G.brkspeed = brkspd
_G.betabrkladder = true
_G.betabrkspeed = btbrkspd
--fnc
function brkLdr()
...
TabBETA:AddTextbox({
	...
	Default = "",
	TextDisappear = true,
	Callback = function(btbrkspd)
                _G.betabrkspeed = btbrkspd
	end	  
})

TabBETA:AddParagraph("work in progress","m1kpee is working on v3, when he completes the script, he will move the functions from this tab to the main tab")
